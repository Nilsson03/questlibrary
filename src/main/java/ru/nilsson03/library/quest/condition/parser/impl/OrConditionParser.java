...
import ru.nilsson03.library.quest.condition.impl.OrCondition;
...
public class OrConditionParser implements Parser<QuestCondition> {
    private final ConditionParserRegistry registry;

    public OrConditionParser(ConditionParserRegistry registry) {
